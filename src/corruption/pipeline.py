...
# RGB uses imagecorruptions library severity 1/2/3 directly; TIR uses custom helpers above.
_RGB_DISPATCH = {
...
def apply_corruption(
    ...
    """Apply a single corruption to one modality stream. Returns uint8, same shape as input."""
    if modality == "rgb":
