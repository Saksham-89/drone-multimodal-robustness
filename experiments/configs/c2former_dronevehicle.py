# C2Former S2ANet training config for DroneVehicle dataset
# Self-contained (no _base_ inheritance) so it can live outside the C2Former repo.
#
...
#
# Prereq: python scripts/create_2stream_pretrain.py
...
model = dict(
    ...
    backbone=dict(
        type='C2FormerResNet',
        fmap_size=(128, 160),          # 512x640 input / 4 (stem+pool)
